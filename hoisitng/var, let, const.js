...
- 함수 스코프 - 함수 내에서 선언된 변수는 해당 함수 내에서만 사용 가능하다(함수 스코프만 적용된다).
- 중복 선언, 함수에서만 scope가 적용되는 문제로 인해 var를 사용하는 것을 권장하지 않는다. 
*/

// 변수는 hoisting되지만 할당은 hoisting 되지 않는다.
// hoisting된 내용을 그대로 출력한다.
...
* TDZ(Temporal Dead Zone)
  어떤 변수에 대한 선언문이 나오기 전까의 범위는 그 변수가 사용될 수 없는 zone이라는 의미이다.
*/
